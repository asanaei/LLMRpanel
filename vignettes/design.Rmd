...
The dispersion in this arithmetic comes from the model panel, not from
human respondents, so treat the output as a reading of the pilot
instrument, not as a sample-size plan for a human study.
